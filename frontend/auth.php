...
$rolePermissions = [
    ...
    'manage_returns' => ['owner', 'manager', 'gudang', 'kasir'],
    'manage_quotations' => ['owner', 'manager', 'kasir'],
    'manage_sales_orders' => ['owner', 'manager', 'gudang', 'kasir'],
    'manage_pricing' => ['owner', 'manager'],
    'manage_users' => ['owner', 'manager', 'super_admin'],
    'manage_settings' => ['owner', 'manager', 'super_admin'],
    ...
    'manage_fleet' => ['owner', 'manager', 'gudang'],
