...
<div class="container mt-4">
    ...
    <div class="card"><div class="card-body">
        <?php if ($tab === 'trial_balance'): ?>
            ...
            <div class="table-responsive"><table class="table table-sm"><thead><tr><th>Kode</th><th>Akun</th><th>Tipe</th><th class="text-end">Debit</th><th class="text-end">Kredit</th></tr></thead><tbody>
            ...
            <?php endforeach; ?>
            </tbody><tfoot><tr class="table-dark"><td colspan="3"><strong>Total</strong></td><td class="text-end"><strong><?= rupiah($data['total_debit'] ?? 0) ?></strong></td><td class="text-end"><strong><?= rupiah($data['total_credit'] ?? 0) ?></strong></td></tr></tfoot></table></div>
        ...
        <?php elseif ($tab === 'general_ledger'): ?>
            <h5>Buku Besar</h5>
            <div class="table-responsive"><table class="table table-sm"><thead><tr><th>Tanggal</th><th>No Jurnal</th><th>Deskripsi</th><th>Akun</th><th class="text-end">Debit</th><th class="text-end">Kredit</th><th class="text-end">Saldo</th></tr></thead><tbody>
        ...
        <?php elseif ($tab === 'journal_entries'): ?>
            ...
            <div class="card mb-2"><div class="card-body">
                ...
                <div class="table-responsive"><table class="table table-sm mb-0"><thead><tr><th>Akun</th><th class="text-end">Debit</th><th class="text-end">Kredit</th></tr></thead><tbody>
        ...
        <?php elseif ($tab === 'chart_of_accounts'): ?>
            <h5>Bagan Akun</h5>
            <div class="table-responsive"><table class="table table-sm"><thead><tr><th>Kode</th><th>Nama</th><th>Tipe</th><th>Subtype</th><th>Status</th></tr></thead><tbody>
