...
class IoTApiTest extends TestCase
{
    ...
    {
        $response = $this->actingAsUser()->getJson('/api/v1/iot/sensors');
        $response->assertStatus(200)->assertJsonPath('success', true);
    }

    public function test_can_register_sensor(): void
    {
        $response = $this->actingAsUser()->postJson('/api/v1/iot/sensors', [
    ...
    {
        $response = $this->actingAsUser()->getJson('/api/v1/iot/alerts');
        $response->assertStatus(200)->assertJsonPath('success', true);
    }
}
