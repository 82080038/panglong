...
class AppSettingSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('app_settings')->insertOrIgnore([
            ...
            ['key' => 'company_name', 'value' => 'PT Panglong Bangunan Jaya', 'type' => 'string', 'description' => 'Company name for print'],
            ['key' => 'company_address', 'value' => 'Jl. Raya Industri No. 45, Bekasi, Jawa Barat', 'type' => 'string', 'description' => 'Company address'],
            ['key' => 'company_phone', 'value' => '021-88556677', 'type' => 'string', 'description' => 'Company phone'],
